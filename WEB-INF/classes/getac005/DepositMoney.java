...
public class DepositMoney extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		out.println("<BODY>");
		out.println("<CENTER>");
		out.println("<H4>"+currentUser+" Please Specify The Amount Desired <BR><BR></H4>");
		...
		out.println("<TR><TD>Account ID: <select name='AccountID'> "
				...
				+ "</select></TD></TR>");
		out.println("<TR><TD>Deposit Amount : <INPUT TYPE=Text Name='Amount'></TD></TR>");
		out.println("</TABLE>");
		out.println("<INPUT TYPE='Submit' NAME='Deposite' VALUE='Submit'>");
