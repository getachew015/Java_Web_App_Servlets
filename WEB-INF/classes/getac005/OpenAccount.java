...
public class OpenAccount extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		out.println("<BODY>");
		out.println("<CENTER>");
		out.println("<H4>"+currentUser+" Please Specify The Information Required To Open Account <BR><BR></H4>");
		...
		out.println("<TR><TD>Account ID: <select name='AccountID'> "
				...
				+ "</select></TD></TR>");
		out.println("<TR><TD>Initial Amount: <INPUT TYPE=Text Name='Amount'></TD></TR>");
		out.println("</TABLE>");
